...
type ReplicaStatus struct {
	...
	StorageHost string `protobuf:"bytes,1,opt,name=storage_host,json=storageHost,proto3" json:"storage_host,omitempty"`
}
...
func (*RaftGroupReplicaStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c36b33a96ae4b7, []int{25}
}
...
func init() {
	...
	proto.RegisterType((*Empty)(nil), "ptarmiganpb.Empty")
...
var fileDescriptor_92c36b33a96ae4b7 = []byte{
	...
	,
}
